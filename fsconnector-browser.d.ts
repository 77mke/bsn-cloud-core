...
import { AssetType, BsAssetItem, BsAssetLocator, BsImageData, BsLocalAssetThumbnail, BsLocalFileBuffer, BsMediaFileData, BsProfileEntity, BsUploadFileSource, BsUploadWebPageSessionSpec, DecoderName, FileSpec, MediaLegalityResults, MediaType, ParsedProbeDataResult, PlayerModel, ProbeCanPlayResult, ProbeContentResolutionType, VideoMode } from './bscore';
/**
